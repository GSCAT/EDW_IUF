...
where ((a11.SHIP_CANCEL_DATE >= DATE '2016-01-31' ) or (a11.PLANNED_STOCKED_DATE >= DATE '2016-01-31' ))
...
SET CATEGORY = (SELECT STAGE_STYLE_CATEGORY.CATEGORY FROM STAGE_STYLE_CATEGORY 
	...
	WHERE SRAA_SAND.EDW_IUF_YTD.CATEGORY IS NULL ;
...
SET MetricShipDate = CASE
		...
		END
	Where  (SRAA_SAND.EDW_IUF_YTD.SALES_TERMS_CODE = 'DDP' OR SRAA_SAND.EDW_IUF_YTD.SALES_TERMS_CODE = 'DDU')  AND SRAA_SAND.EDW_IUF_YTD.TRADE_LANE_TYPE = 'Domestic' ;
...
SET MetricShipDate = CASE
		...
		WHEN SRAA_SAND.EDW_IUF_YTD.ACTUAL_STOCKED_LCL_DATE IS NOT NULL THEN 'SD'
		END
	Where (SRAA_SAND.EDW_IUF_YTD.SALES_TERMS_CODE = 'DDP' OR SRAA_SAND.EDW_IUF_YTD.SALES_TERMS_CODE = 'DDU')  AND SRAA_SAND.EDW_IUF_YTD.TRADE_LANE_TYPE = 'International' ;
...
UPDATE SRAA_SAND.EDW_IUF_YTD
SET Lateness= CASE
		WHEN  (SRAA_SAND.EDW_IUF_YTD.SHIP_MODE_CD = 'A' AND SRAA_SAND.EDW_IUF_YTD.SALES_TERMS_CODE = 'CFR') AND (SRAA_SAND.EDW_IUF_YTD.MetricShipDate - SRAA_SAND.EDW_IUF_YTD.Ship_Cancel_Date >2) THEN 'Late'
		WHEN not (SRAA_SAND.EDW_IUF_YTD.SHIP_MODE_CD = 'A' AND SRAA_SAND.EDW_IUF_YTD.SALES_TERMS_CODE = 'CFR') AND (SRAA_SAND.EDW_IUF_YTD.MetricShipDate - SRAA_SAND.EDW_IUF_YTD.CTRT_SHP_DT >2) THEN 'Late'
		Else 'OnTime' END
...
UPDATE SRAA_SAND.EDW_IUF_YTD
SET DAYS_LATE= CASE
		WHEN  (SRAA_SAND.EDW_IUF_YTD.SHIP_MODE_CD = 'A' AND SRAA_SAND.EDW_IUF_YTD.SALES_TERMS_CODE = 'CFR') Then SRAA_SAND.EDW_IUF_YTD.MetricShipDate - SRAA_SAND.EDW_IUF_YTD.Ship_Cancel_Date 
		WHEN not (SRAA_SAND.EDW_IUF_YTD.SHIP_MODE_CD = 'A' AND SRAA_SAND.EDW_IUF_YTD.SALES_TERMS_CODE = 'CFR') THEN SRAA_SAND.EDW_IUF_YTD.MetricShipDate - SRAA_SAND.EDW_IUF_YTD.CTRT_SHP_DT
		END
	where SRAA_SAND.EDW_IUF_YTD.MetricShipDate is not null;