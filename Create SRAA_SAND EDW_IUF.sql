/*  SRAA_SAND.EDW_IUF This is an extended version of the  main production table for SOT/OTS timebound to 2013 forward. Data is refreshed as needed

query:

select max(Data_Pulled) from SRAA_SAND.EDW_IUF

to determing when this table was last updated
*/
...
CREATE MULTISET TABLE SRAA_SAND.EDW_IUF ,NO FALLBACK ,
     ...
     MDSE_SEAS_TYP_NM VARCHAR(50) CHARACTER SET LATIN NOT CASESPECIFIC,
      ...
      Shp_Cxl_WK BYTEINT,
      Shp_Cxl_YR SMALLINT,
      Shp_Cxl_Month SMALLINT,
      Shp_Cxl_Month_Desc VARCHAR(30) CHARACTER SET LATIN NOT CASESPECIFIC,
      FIS_QTR_DESC  VARCHAR(30) CHARACTER SET LATIN NOT CASESPECIFIC,
      ...
      Planned_Stock_YR SMALLINT,
       	Planned_Stock_Month SMALLINT,
	    Planned_Stock_Month_Desc VARCHAR(30) CHARACTER SET LATIN NOT CASESPECIFIC,
...
case
	...
	a115.FIS_WK_NBR Shp_Cxl_WK,
	a115.FIS_YR_NBR Shp_Cxl_YR,
	a115.FIS_MO_NBR,
	a115.FIS_MO_DESC,
	a115.FIS_QTR_DESC,
	...
	a113.FIS_WK_NBR InDC_WK,
	a113.FIS_YR_NBR InDC_YR,
	a11.PLANNED_STOCKED_DATE,
	a114.FIS_WK_NBR Planned_Stock_Week,
	a114.FIS_YR_NBR Planned_Stock_YR,
	a114.FIS_MO_NBR as Planned_Stock_Month,
	a114.FIS_MO_DESC as Planned_Stock_Month_Desc,
...
from VIEWORDER.VIUFF_INBND_UNT_FCST_FCT a11
	...
	left outer join  VIEWFNDT.VFDTD_FIS_DT_DIM   a113
		on a113.FIS_CAL_DT = a11.PLANNED_IN_DC_DATE
	left outer join  VIEWFNDT.VFDTD_FIS_DT_DIM   a114
		on a114.FIS_CAL_DT = a11.PLANNED_STOCKED_DATE
	left outer join  VIEWFNDT.VFDTD_FIS_DT_DIM   a115
		on a115.FIS_CAL_DT = a11.SHIP_CANCEL_DATE
		
	--left outer join  VIEWFNDT.VFDTD_FIS_DT_DIM   a120
		--on a120.FIS_CAL_DT = a11.SHIP_CANCEL_DATE
...
SET CATEGORY = (SELECT STAGE_STYLE_CATEGORY.CATEGORY FROM SRAA_SAND.STAGE_STYLE_CATEGORY 
