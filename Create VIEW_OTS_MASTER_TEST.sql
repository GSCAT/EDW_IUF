--drop view SRAA_SAND.VIEW_OTS_MASTER_TEST;

Create VIEW SRAA_SAND.VIEW_OTS_MASTER_TEST AS
	...
	a1.ACTUAL_STOCKED_LCL_DATE StkdDte,
	 a1.ORD_QTY  as Units,
		case
			...
			WHEN (a1.ACTUAL_STOCKED_LCL_DATE is null and ((a1.Data_Pulled -1) - a1.PLANNED_STOCKED_DATE between -45 and 2)) then 'OnTime' 
		...
		case
			...
			WHEN (a1.ACTUAL_STOCKED_LCL_DATE is NULL AND ((a1.Data_Pulled -1) - a1.PLANNED_STOCKED_DATE < 45)) THEN (a1.Data_Pulled -1) - a1.PLANNED_STOCKED_DATE
			WHEN (a1.ACTUAL_STOCKED_LCL_DATE is NULL AND ((a1.Data_Pulled -1) - a1.PLANNED_STOCKED_DATE > -(45))) THEN (a1.Data_Pulled -1) - a1.PLANNED_STOCKED_DATE
			WHEN (a1.ACTUAL_STOCKED_LCL_DATE is NULL AND ((a1.Data_Pulled -1) - a1.PLANNED_STOCKED_DATE > 45)) THEN 0
			WHEN (a1.ACTUAL_STOCKED_LCL_DATE is NULL AND ((a1.Data_Pulled -1) - a1.PLANNED_STOCKED_DATE < -(45))) THEN 0
