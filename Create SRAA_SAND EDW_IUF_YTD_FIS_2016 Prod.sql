DROP TABLE SRAA_SAND.EDW_IUF_YTD_FIS_2016;

CREATE MULTISET TABLE SRAA_SAND.EDW_IUF_YTD_FIS_2016 ,NO FALLBACK ,
     NO BEFORE JOURNAL,
     NO AFTER JOURNAL,
     CHECKSUM = DEFAULT,
...
insert into SRAA_SAND.EDW_IUF_YTD_FIS_2016
select
...
--where ((a11.SHIP_CANCEL_DATE between DATE '2016-10-31' and  DATE '2017-02-25'  ) or (a11.PLANNED_STOCKED_DATE between DATE '2016-10-28' and DATE '2017-01-28' ))	
...
DROP TABLE  SRAA_SAND.STAGE_STYLE_CATEGORY;
 ...
 CREATE MULTISET  TABLE SRAA_SAND.STAGE_STYLE_CATEGORY AS  (Select OPR_BRD_STY_ID, CATEGORY from  SRAA_SAND.EDW_IUF_YTD_FIS_2016 
...
UPDATE SRAA_SAND.EDW_IUF_YTD_FIS_2016
SET CATEGORY = (SELECT STAGE_STYLE_CATEGORY.CATEGORY FROM STAGE_STYLE_CATEGORY 
	WHERE SRAA_SAND.EDW_IUF_YTD_FIS_2016.OPR_BRD_STY_ID = STAGE_STYLE_CATEGORY.OPR_BRD_STY_ID)
	WHERE SRAA_SAND.EDW_IUF_YTD_FIS_2016.CATEGORY = 'Category Other' ;
	
-- Start of MetricShipDate logic
-- 1) Set FOB/CFR Ocean to LP
UPDATE SRAA_SAND.EDW_IUF_YTD_FIS_2016
SET MetricShipDate = SRAA_SAND.EDW_IUF_YTD_FIS_2016.ACTUAL_LP_LCL_DATE, ShipDateChoice = 'LP'
	WHERE  (SRAA_SAND.EDW_IUF_YTD_FIS_2016.SALES_TERMS_CODE = 'FOB' OR SRAA_SAND.EDW_IUF_YTD_FIS_2016.SALES_TERMS_CODE = 'CFR')
	AND SRAA_SAND.EDW_IUF_YTD_FIS_2016.SHIP_MODE_CD = 'O'
	AND SRAA_SAND.EDW_IUF_YTD_FIS_2016.ACTUAL_LP_LCL_DATE IS NOT NULL;

-- 2) Set FOB Air to OC
UPDATE SRAA_SAND.EDW_IUF_YTD_FIS_2016
SET MetricShipDate = SRAA_SAND.EDW_IUF_YTD_FIS_2016.ACTUAL_ORIGIN_CONSOL_LCL_DATE, ShipDateChoice = 'OC'
	WHERE  (SRAA_SAND.EDW_IUF_YTD_FIS_2016.SALES_TERMS_CODE = 'FOB')
	AND SRAA_SAND.EDW_IUF_YTD_FIS_2016.SHIP_MODE_CD = 'A'
	AND SRAA_SAND.EDW_IUF_YTD_FIS_2016.ACTUAL_ORIGIN_CONSOL_LCL_DATE IS NOT NULL;
...
Set Trade_Lane_Type = Case 
			when  SRAA_SAND.EDW_IUF_YTD_FIS_2016.XFR_PT_COUNTRY_CODE=SRAA_SAND.EDW_IUF_YTD_FIS_2016.DEST_COUNTRY_CODE  then 'Domestic'
...
SET MetricShipDate = SRAA_SAND.EDW_IUF_YTD_FIS_2016.ACTUAL_ORIGIN_CONSOL_LCL_DATE, ShipDateChoice = 'OC'
	WHERE  (SRAA_SAND.EDW_IUF_YTD_FIS_2016.SALES_TERMS_CODE = 'FOB')
	AND SRAA_SAND.EDW_IUF_YTD_FIS_2016.SHIP_MODE_CD = 'M'
	AND SRAA_SAND.EDW_IUF_YTD_FIS_2016.TRADE_LANE_TYPE = 'International' 
	AND SRAA_SAND.EDW_IUF_YTD_FIS_2016.ACTUAL_ORIGIN_CONSOL_LCL_DATE IS NOT NULL;

--3) Update MetricShipDate to Dom Depart for FOB motor domestic
UPDATE SRAA_SAND.EDW_IUF_YTD_FIS_2016
SET MetricShipDate = SRAA_SAND.EDW_IUF_YTD_FIS_2016.ACTUAL_DOM_DEPART_LCL_DATE, ShipDateChoice = 'DD'
	WHERE  (SRAA_SAND.EDW_IUF_YTD_FIS_2016.SALES_TERMS_CODE = 'FOB')
	AND SRAA_SAND.EDW_IUF_YTD_FIS_2016.SHIP_MODE_CD = 'M'
	AND SRAA_SAND.EDW_IUF_YTD_FIS_2016.TRADE_LANE_TYPE = 'Domestic'
	AND SRAA_SAND.EDW_IUF_YTD_FIS_2016.ACTUAL_DOM_DEPART_LCL_DATE IS NOT NULL;

--4) Update MetricShipDate to Origin Consol
UPDATE SRAA_SAND.EDW_IUF_YTD_FIS_2016
SET MetricShipDate = SRAA_SAND.EDW_IUF_YTD_FIS_2016.ACTUAL_ORIGIN_CONSOL_LCL_DATE, ShipDateChoice = 'OC'
	WHERE  (SRAA_SAND.EDW_IUF_YTD_FIS_2016.SALES_TERMS_CODE = 'FCA')
	AND SRAA_SAND.EDW_IUF_YTD_FIS_2016.ACTUAL_ORIGIN_CONSOL_LCL_DATE IS NOT NULL;

-- 5) Update MetricShipDate to DES_CONSOL for DDP/DDU Domestic
UPDATE SRAA_SAND.EDW_IUF_YTD_FIS_2016
SET MetricShipDate = CASE
		WHEN SRAA_SAND.EDW_IUF_YTD_FIS_2016.ACTUAL_DEST_CONSOL_LCL_DATE IS NOT NULL THEN SRAA_SAND.EDW_IUF_YTD_FIS_2016.ACTUAL_DEST_CONSOL_LCL_DATE
		WHEN  SRAA_SAND.EDW_IUF_YTD_FIS_2016.ACTUAL_DOM_DEPART_LCL_DATE IS NOT NULL THEN SRAA_SAND.EDW_IUF_YTD_FIS_2016.ACTUAL_DOM_DEPART_LCL_DATE
		WHEN SRAA_SAND.EDW_IUF_YTD_FIS_2016.ACTUAL_IN_DC_LCL_DATE IS NOT NULL THEN SRAA_SAND.EDW_IUF_YTD_FIS_2016.ACTUAL_IN_DC_LCL_DATE
		WHEN ACTUAL_STOCKED_LCL_DATE IS NOT NULL THEN ACTUAL_STOCKED_LCL_DATE
		END,
		
		ShipDateChoice = CASE
		WHEN SRAA_SAND.EDW_IUF_YTD_FIS_2016.ACTUAL_DEST_CONSOL_LCL_DATE IS NOT NULL THEN 'DCON'
		WHEN  SRAA_SAND.EDW_IUF_YTD_FIS_2016.ACTUAL_DOM_DEPART_LCL_DATE IS NOT NULL THEN 'DD'
		WHEN SRAA_SAND.EDW_IUF_YTD_FIS_2016.ACTUAL_IN_DC_LCL_DATE IS NOT NULL THEN 'InDC'
		WHEN SRAA_SAND.EDW_IUF_YTD_FIS_2016.ACTUAL_STOCKED_LCL_DATE IS NOT NULL THEN 'SD'
		END
	Where  (SRAA_SAND.EDW_IUF_YTD_FIS_2016.SALES_TERMS_CODE = 'DDP' OR SRAA_SAND.EDW_IUF_YTD_FIS_2016.SALES_TERMS_CODE = 'DDU')  
				AND SRAA_SAND.EDW_IUF_YTD_FIS_2016.TRADE_LANE_TYPE = 'Domestic' ;

-- 6) Update MetricShipDate to Origin Consol for DDP/DDU International
UPDATE SRAA_SAND.EDW_IUF_YTD_FIS_2016
SET MetricShipDate = CASE
			WHEN SRAA_SAND.EDW_IUF_YTD_FIS_2016.ACTUAL_ORIGIN_CONSOL_LCL_DATE  IS NOT NULL THEN SRAA_SAND.EDW_IUF_YTD_FIS_2016.ACTUAL_ORIGIN_CONSOL_LCL_DATE 
			WHEN SRAA_SAND.EDW_IUF_YTD_FIS_2016.ACTUAL_LP_LCL_DATE IS NOT NULL THEN SRAA_SAND.EDW_IUF_YTD_FIS_2016.ACTUAL_LP_LCL_DATE
			WHEN SRAA_SAND.EDW_IUF_YTD_FIS_2016.ACTUAL_IN_DC_LCL_DATE IS NOT NULL THEN SRAA_SAND.EDW_IUF_YTD_FIS_2016.ACTUAL_IN_DC_LCL_DATE
			WHEN SRAA_SAND.EDW_IUF_YTD_FIS_2016.ACTUAL_STOCKED_LCL_DATE IS NOT NULL THEN SRAA_SAND.EDW_IUF_YTD_FIS_2016.ACTUAL_STOCKED_LCL_DATE
			END,
		
		ShipDateChoice = CASE
			WHEN SRAA_SAND.EDW_IUF_YTD_FIS_2016.ACTUAL_ORIGIN_CONSOL_LCL_DATE  IS NOT NULL THEN 'OC'
			WHEN  SRAA_SAND.EDW_IUF_YTD_FIS_2016.ACTUAL_LP_LCL_DATE IS NOT NULL THEN 'LP'
			WHEN SRAA_SAND.EDW_IUF_YTD_FIS_2016.ACTUAL_IN_DC_LCL_DATE IS NOT NULL THEN 'InDC'
			WHEN SRAA_SAND.EDW_IUF_YTD_FIS_2016.ACTUAL_STOCKED_LCL_DATE IS NOT NULL THEN 'SD'
			END
	Where (SRAA_SAND.EDW_IUF_YTD_FIS_2016.SALES_TERMS_CODE = 'DDP' OR SRAA_SAND.EDW_IUF_YTD_FIS_2016.SALES_TERMS_CODE = 'DDU')  
...
SET MetricShipDate = CASE
		...
		WHEN SRAA_SAND.EDW_IUF_YTD_FIS_2016.ACTUAL_STOCKED_LCL_DATE IS NOT NULL THEN 'SD'
		END
	Where  (SRAA_SAND.EDW_IUF_YTD_FIS_2016.SALES_TERMS_CODE = 'CFR') AND (SRAA_SAND.EDW_IUF_YTD_FIS_2016.SHIP_MODE_CD = 'M' OR SRAA_SAND.EDW_IUF_YTD_FIS_2016.SHIP_MODE_CD ='A') ;

-- 8) Set all EXW to XF
UPDATE SRAA_SAND.EDW_IUF_YTD_FIS_2016
SET MetricShipDate = SRAA_SAND.EDW_IUF_YTD_FIS_2016.ACTUAL_X_FACTORY_LCL_DATE, ShipDateChoice = 'XF'
	WHERE  (SRAA_SAND.EDW_IUF_YTD_FIS_2016.SALES_TERMS_CODE = 'EXW')
	AND SRAA_SAND.EDW_IUF_YTD_FIS_2016.ACTUAL_X_FACTORY_LCL_DATE IS NOT NULL;

-- 9) TNR exception
UPDATE SRAA_SAND.EDW_IUF_YTD_FIS_2016
SET MetricShipDate = SRAA_SAND.EDW_IUF_YTD_FIS_2016.ACTUAL_X_FACTORY_LCL_DATE, ShipDateChoice = 'XF'
	WHERE  (SRAA_SAND.EDW_IUF_YTD_FIS_2016.Program_Type = 'TNR')
	AND SRAA_SAND.EDW_IUF_YTD_FIS_2016.ACTUAL_X_FACTORY_LCL_DATE IS NOT NULL;
...
/*UPDATE SRAA_SAND.EDW_IUF_YTD_FIS_2016
SET Lateness= CASE
		WHEN  (SRAA_SAND.EDW_IUF_YTD_FIS_2016.SHIP_MODE_CD = 'A' 
				AND SRAA_SAND.EDW_IUF_YTD_FIS_2016.SALES_TERMS_CODE = 'CFR') 
				AND (SRAA_SAND.EDW_IUF_YTD_FIS_2016.MetricShipDate - SRAA_SAND.EDW_IUF_YTD_FIS_2016.Ship_Cancel_Date >2) 
			THEN 'Late'
			
		WHEN not (SRAA_SAND.EDW_IUF_YTD_FIS_2016.SHIP_MODE_CD = 'A' 
				AND SRAA_SAND.EDW_IUF_YTD_FIS_2016.SALES_TERMS_CODE = 'CFR') 
				AND (SRAA_SAND.EDW_IUF_YTD_FIS_2016.MetricShipDate - SRAA_SAND.EDW_IUF_YTD_FIS_2016.CTRT_SHP_DT >2) 
			THEN 'Late'
		Else 'OnTime' 
END
		
	where SRAA_SAND.EDW_IUF_YTD_FIS_2016.MetricShipDate is not null;*/
	
	
UPDATE SRAA_SAND.EDW_IUF_YTD_FIS_2016
SET Lateness= CASE
				when (SRAA_SAND.EDW_IUF_YTD_FIS_2016.MetricShipDate - SRAA_SAND.EDW_IUF_YTD_FIS_2016.CTRT_SHP_DT >2) 
			THEN 'Late'
		Else 'OnTime' 
END
...
SET Source_System = CASE
		WHEN trim(SRAA_SAND.EDW_IUF_YTD_FIS_2016.DEST_PO_ID) between '0' and '9999999'THEN 'SCMS'
		WHEN trim(SRAA_SAND.EDW_IUF_YTD_FIS_2016.DEST_PO_ID) not between '0' and '9999999'THEN 'PROMPT'
		END
	where SRAA_SAND.EDW_IUF_YTD_FIS_2016.DEST_PO_ID is not null;
		
--Calculate Days Late 
/*UPDATE SRAA_SAND.EDW_IUF_YTD_FIS_2016
SET DAYS_LATE= CASE
		WHEN  (SRAA_SAND.EDW_IUF_YTD_FIS_2016.SHIP_MODE_CD = 'A' 
				AND SRAA_SAND.EDW_IUF_YTD_FIS_2016.SALES_TERMS_CODE = 'CFR') Then SRAA_SAND.EDW_IUF_YTD_FIS_2016.MetricShipDate - SRAA_SAND.EDW_IUF_YTD_FIS_2016.Ship_Cancel_Date 
		WHEN not (SRAA_SAND.EDW_IUF_YTD_FIS_2016.SHIP_MODE_CD = 'A' 
				AND SRAA_SAND.EDW_IUF_YTD_FIS_2016.SALES_TERMS_CODE = 'CFR') THEN SRAA_SAND.EDW_IUF_YTD_FIS_2016.MetricShipDate - SRAA_SAND.EDW_IUF_YTD_FIS_2016.CTRT_SHP_DT
		END
	where SRAA_SAND.EDW_IUF_YTD_FIS_2016.MetricShipDate is not null;*/
	
UPDATE SRAA_SAND.EDW_IUF_YTD_FIS_2016
SET DAYS_LATE =  SRAA_SAND.EDW_IUF_YTD_FIS_2016.MetricShipDate - SRAA_SAND.EDW_IUF_YTD_FIS_2016.CTRT_SHP_DT
	where SRAA_SAND.EDW_IUF_YTD_FIS_2016.MetricShipDate is not null;
