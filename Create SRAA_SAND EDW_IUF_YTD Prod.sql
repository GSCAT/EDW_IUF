...
CREATE MULTISET TABLE SRAA_SAND.EDW_IUF_YTD ,NO FALLBACK ,
     ...
     MDSE_SEAS_TYP_NM VARCHAR(50) CHARACTER SET LATIN NOT CASESPECIFIC,
      ...
      PROMPT_COUNTRY_ORIGIN CHAR(2) CHARACTER SET LATIN NOT CASESPECIFIC,
...
case
	...
	a11.ORIGIN_COUNTRY_CODE as PROMPT_COUNTRY_ORIGIN,
...
from VIEWORDER.VIUFF_INBND_UNT_FCST_FCT a11
	...
	left outer join (Select  AGT_DEPT_ID, AGT_DEPT_ABBR_DESC  as AGT_DEPT_ABBR_DESC, SRC_LST_UPDT_DT from ViewDST.TAGDL_AGT_DEPT_LOOKUP 
		Qualify
		row_number() Over (partition by AGT_DEPT_ID order by SRC_LST_UPDT_DT desc)= 1 ) a112  --- finds the latest description for the Agent Department by SRC_LST_UPDT_DT
