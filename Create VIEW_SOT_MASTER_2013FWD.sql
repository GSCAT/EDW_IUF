--drop view SRAA_SAND.VIEW_SOT_MASTER_2013FWD;

Create VIEW SRAA_SAND.VIEW_SOT_MASTER_2013FWD AS
...
(Select
	...
	Row_NUMBER() Over(order by (sum(Total_FCST_ELC) )desc ) as Vendor_Rank from SRAA_SAND.EDW_IUF
